...
namespace AssetManagement.Application.Services.AssignmentServices
{
    public class AssignmentService : IAssignmentService
    {
        ...
        {
            var assignment = await _assignmentRepository.GetByCondition(a => a.Id == id && a.DeletedAt != null).AsNoTracking().FirstOrDefaultAsync();
        ...
        {
            var query = _assignmentRepository.GetByCondition(x => x.AssetId == assetId && x.DeletedAt != null)
                .Include(x => x.Asset)
